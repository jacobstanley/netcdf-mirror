...
'tst_utf8 tst_fills tst_fills2 tst_fillbug tst_xplatform tst_xplatform2 '\
'tst_h_atts2 tst_endian_fill'

# These don't work yet: tst_grps2 tst_fills tst_xplatform2 tst_interops6 tst_strings 
