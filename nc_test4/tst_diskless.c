...
#define WINSTON_LEN2 1
      ...
      int ndims_in, nvars_in, natts_in, unlimdimid_in, dimids_in[NDIMS3];
      char name_in[NC_MAX_NAME + 1];
      nc_type type_in;
   ...
   SUMMARIZE_ERR;
   printf("*** testing diskless file with 1 2D var with unlimited dimension reading twice...");
   {
#define RADAR "radar"
...
#define CLOUD_LEN2 2
	 ...
	 for (b = 0; b < METEOROLOGY_LEN2; b++)
      ...
      if (char_datum != char_data[1][1]) ERR;
